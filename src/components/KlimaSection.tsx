      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Each Green Chonk NFT left on sale holds 100 $KLIMA (staking for September's TGE) and is backed by real carbon offset certificates via carbonmark.com. With an average of 7.75 tonnes CO₂ retired per NFT. Here is the green impact of this collection:
          </p>
        </div>
